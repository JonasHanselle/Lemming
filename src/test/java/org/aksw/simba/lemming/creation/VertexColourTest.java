...
public class VertexColourTest {
	...
	public void test() {
		...
		// cGraph.setVertexColour(14, new BitSet(78));
		...
		for (int i = 0; i < vertexColourDistribution.getSampleSpace().length; ++i) {
			expectedCounts.put(vertexColourDistribution.getSampleSpace()[i], vertexColourDistribution.getValues()[i]);
		}
